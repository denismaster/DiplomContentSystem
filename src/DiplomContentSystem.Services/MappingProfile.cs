    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<Teacher, TeacherListItem>()
                .ForMember(item => item.Speciality, opt => opt.MapFrom(src => (src.Department != null) ? src.Department.ShortName : null))
            ...
            CreateMap<TeacherEditItem, Teacher>()
                ...
                .ForMember(item => item.DepartmentId, opt => opt.UseValue(1))
