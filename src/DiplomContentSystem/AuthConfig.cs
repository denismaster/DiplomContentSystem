...
namespace DiplomContentSystem
{
    public static class AuthConfig
    {
        ...
        public static IApplicationBuilder ConfigureJwtBearerAuthentication(this IApplicationBuilder app, IConfiguration configuration, SymmetricSecurityKey _signingKey)
        {
            var jwtAppSettingOptions = configuration.GetSection(nameof(JwtIssuerOptions));
    ...
    public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// Set the remember timespan the token will be valid for (default is 10 days)
        /// </summary>
        public TimeSpan RememberValidFor { get; set; } = TimeSpan.FromDays(10);
